...
cd ~
cd frappe-bench
printf "${yellow}Getting ERP...${clear}\n"

sudo git clone https://github.com/frappe/erpnext.git --branch version-13 --depth 1 --origin upstream
printf "${yellow}Installing ERP...!${clear}"
me=$(whoami)
/home/${me}/frappe-bench/env/bin/python -m pip install --quiet --upgrade -e /home/${me}/frappe-bench/apps/erpnext
...
sudo chown ${me}:${me} /home/${me}/frappe-bench/erpnext/

bench --site first-site install-app erpnext
bench --site first-site --force reinstall
